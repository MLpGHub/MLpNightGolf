...
void fragment(){
	...
	//ALBEDO = vec3(2.0, 0.0+noise, 0.0 + noise); //Display noise. Blue for valleys, green for peaks
	ALBEDO = vec3(1.0, noise*0.2, noise*0.1); //Display dampening. Red is full dampening, blue is none
	EMISSION = vec3(1.0, noise*0.2, noise*0.1);
}